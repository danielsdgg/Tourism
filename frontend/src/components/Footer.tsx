...
const Footer = () => {
  return (
    <div className='bg-[#104c4e]'>
      ...
      <div>
        <Link to={'/'}><img src="https://i.pinimg.com/736x/6d/37/ad/6d37ad2adfafaf9d92885e1c2e20a3fd.jpg" className="h-4/12 w-3/12 mr-2 cursor-pointer" alt="Fashion Design" /></Link>
        <p className='py-4'>Navigate through the website for tours and reach out to us incase of any enquiries.</p>
